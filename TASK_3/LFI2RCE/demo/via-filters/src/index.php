...
<head>
    ...
    <title> LFI2RCE via php-wrappers-and-streams </title>
    <style>
        body {
...
?>
<!-- 
1. rce with php wrapper and stream
2. with phar:// zip:// protocol < need upload function> 
2. rce using filter chain -->